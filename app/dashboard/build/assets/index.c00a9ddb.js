...
const St = () => localStorage.getItem("token"),
  ...
  No = wt((t) => ({
    ...
    fetchCoreSettings: () => {
      t({ isLoading: !0 }),
        Promise.all([
          W("/core").then(({ version: n, started: o, logs_websocket: s }) =>
            t({ version: n, started: o, logs_websocket: s })
          ),
          W("/core/config").then((n) => t({ config: n })),
        ]).finally(() => t({ isLoading: !1 }));
    },
    updateConfig: (n) => (
      t({ isPostLoading: !0 }),
      W("/core/config", { method: "PUT", body: n }).finally(() => {
        t({ isPostLoading: !1 });
      })
    ),
    restartCore: () => W("/core/restart", { method: "POST" }),
  }));
...
const sr = (t) => {
  ...
  Po = x(un, { baseStyle: { w: 5, h: 5, position: "relative", zIndex: "2" } }),
  Wo = x(kt, { baseStyle: { w: 5, h: 5, position: "relative", zIndex: "2" } }),
  ...
  I = wt(
    mn((t, n) => ({
      ...
      resetAllUsage: () =>
        W("/users/reset", { method: "POST" }).then(() => {
      ...
      deleteUser: (o) => (
        t({ editingUser: null }),
        W(`/user/${o.username}`, { method: "DELETE" }).then(() => {
          t({ deletingUser: null }),
            n().refetchUsers(),
      ...
      createUser: (o) =>
        W("/user", { method: "POST", body: o }).then(() => {
          t({ editingUser: null }),
            n().refetchUsers(),
            At.invalidateQueries(Mt);
        }),
      editUser: (o) =>
        W(`/user/${o.username}`, { method: "PUT", body: o }).then(() => {
          n().onEditingUser(null), n().refetchUsers();
        }),
      fetchUserUsage: (o, s) => {
        for (const a in s) s[a] || delete s[a];
        return W(`/user/${o.username}/usage`, { method: "GET", query: s });
      },
      onEditingHosts: (o) => {
        t({ isEditingHosts: o });
      },
      ...
      resetDataUsage: (o) =>
        W(`/user/${o.username}/reset`, { method: "POST" }).then(() => {
          t({ resetUsageUser: null }), n().refetchUsers();
        }),
      revokeSubscription: (o) =>
        W(`/user/${o.username}/revoke_sub`, { method: "POST" }).then((s) => {
...
const Vo = g.exports.forwardRef(
  ...
  Xo = () => {
    try {
      let t = new URL(
        "/api/".startsWith("/") ? window.location.origin + "/api/" : "/api/"
      );
      return (
...
const Jo = () => {
          ...
          children: r(k, {
            ...
            children: [
              e(z, {
                children: e(N, {
                  size: "sm",
                  leftIcon: e(Yo, { className: vt({ "animate-spin": P }) }),
                  onClick: () => b(),
                  children: c(P ? "core.restarting" : "core.restartCore"),
                }),
              }),
              e(k, {
                children: e(N, {
  ...
  Cs = [
    ...
    { title: "h3,h2,http/1.1", value: "h3,h2,http/1.1" },
    { title: "h3,h2", value: "h3,h2" },
  ...
  vs = wt((t) => ({
    ...
    setHosts: (n) => (
      t({ isPostLoading: !0 }),
      W("/hosts", { method: "PUT", body: n }).finally(() => {
        t({ isPostLoading: !1 });
      })
    ),
  }));
const Is = x(vr, { baseStyle: { w: 4, h: 4 } }),
  ...
  Es = ({ hostKey: t, isOpen: n, toggleAccordion: o }) => {
    const { inbounds: s } = I(),
      ...
      i = Ot(),
      { fields: l, append: u, remove: p } = Wn({ control: i.control, name: t }),
    ...
    const f = () => {
      ...
      S = (m) => {
        p(m)
          ...
          .catch((b) => {
            var P, H, E, A, V;
            (((P = b == null ? void 0 : b.response) == null
              ? void 0
              : P.status) === 409 ||
  ...
  lt = wt((t, n) => ({
    nodes: [],
    addNode(o) {
      return W("/node", { method: "POST", body: o });
    },
    fetchNodes() {
      return W("/nodes");
    },
    fetchNodesUsage(o) {
      return W("/nodes/usage", { query: o });
    },
    updateNode(o) {
      return W(`/node/${o.id}`, { method: "PUT", body: o });
    },
    setDeletingNode(o) {
      t({ deletingNode: o });
    },
    reconnectNode(o) {
      return W(`/node/${o.id}/reconnect`, { method: "POST" });
    },
    deleteNode: () => {
      var o;
      return W(`/node/${(o = n().deletingNode) == null ? void 0 : o.id}`, {
        method: "DELETE",
      });
    },
  })),
  ...
  Ws = ({ toggleAccordion: t, resetAccordions: n }) => {
    const o = ue(),
      { t: s } = O(),
      a = Ht(),
      { addNode: i } = lt(),
  ...
  Kr = ({
    ...
    var _, f, S, T, m, b, P, H, E, A, V, Q;
    const { t: u } = O(),
      [p, y] = g.exports.useState(!1),
      { data: d, isLoading: c } = Pt({
        queryKey: "node-settings",
        queryFn: () => W("/node/settings"),
      });
    function C(D) {
            ...
            children: [
              ...
              e(z, {
                ...
                children: e(ut, {
                  ...
                  error:
                    (E =
                      (H = (P = t.formState) == null ? void 0 : P.errors) ==
                      null
                        ? void 0
                        : H.port) == null
                      ? void 0
...
const Bs = x(kt, { baseStyle: { w: 5, h: 5 } }),
      ...
      { getCheckboxProps: f } = Or({
        ...
        onChange: (b) => {
          if ((l.setValue(`inbounds.${n}`, b), b.length === 0)) {
            const P = l.getValues("selected_proxies");
            l.setValue(
              "selected_proxies",
              P.filter((H) => H !== n)
            ),
  ...
  ha = () => {
    ...
    const X = (v) => {
      ...
      K = () => {
        E.reset(Ut()), o(!1), i(null), _(null), P(!1), q("1m");
      },
      dt = () => {
...
`),
  ...
  Sr = () => {
    ...
    const d = (_) => {
      ...
      f.append("username", _.username),
        ...
        s(!0),
        W("/admin/token", { method: "post", body: f })
          .then(({ access_token: S }) => {
            Lo(S), a("/");
          })
          .catch((S) => {
  ...
  Ma = () => W("/admin", { headers: { Authorization: `Bearer ${St()}` } }),
  Na = So(
    [
